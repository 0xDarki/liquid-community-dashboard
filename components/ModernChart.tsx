  ...
  return (
    <div className="space-y-4">
            ...
            <div className="pt-1.5 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-1 max-h-24 overflow-y-auto">
                {botStatus.downtimePeriods.map((downtime, index) => {
                  ...
                  return (
                    <div key={index} className="flex items-center justify-between text-xs bg-red-50 dark:bg-red-900/20 px-2 py-1 rounded">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg pt-3 px-3 pb-0 border border-gray-200 dark:border-gray-700">
